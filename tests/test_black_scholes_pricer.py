...
class TestBlackScholes(unittest.TestCase):
	...
	def test_european_option_prices(self, precision: float = 0.75):
		...
		for i in test_ids:
			...
			computed_price = option.compute_price(BlackScholes)
	...
	def test_european_option_greeks(self, precision: float = 0.02):
		df_prices = self.data_option_prices_eu
		df_greeks = self.data_greeks_eu
		...
		for i in test_ids:
			...
			computed_greeks = option.compute_greeks(BlackScholes)
