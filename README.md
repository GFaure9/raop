...
<div class="warning" style="background-color: #FFE8B2; border-left: 6px solid #FFC857; padding: 10px; margin-bottom: 20px; font-family: 'Helvetica Neue', sans-serif; font-size: 16px;">
